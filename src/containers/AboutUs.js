  ...
  return (
    <div className="Articles">
      <OuterDiv className="margins">
        ...
        <div className="uglyJournal">
          <p>Jacob Kim-Sherman, Editor-In-Chief </p>
          ...
          <p>Jessica Li, Managing Editor—Journal </p>
          ...
          <p>Zac Narimanian, Managing Editor—Online </p>
          ...
          <p>Amina Isayeva, Managing Editor—Operations </p>
